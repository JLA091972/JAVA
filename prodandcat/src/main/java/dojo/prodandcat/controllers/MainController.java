package dojo.prodandcat.controllers;
...
import dojo.prodandcat.services.CategoryService;
import dojo.prodandcat.services.ProductService;
...
public class MainController {
    ...
    public String updateCategory(@PathVariable("id") Long id, @RequestParam(value = "productId") Long productId,
            Model model) {
        Category category = categoryService.findById(id);
